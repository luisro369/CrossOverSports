...
public class FavoritePlayersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  List<PlayerR> playersList = MainActivity.db.playerDAO().getAll();
       ...
       List<PlayerR> playersList = MainActivity.db.playerDAO().playerByCreator(byCreator);*/
...
//        Log.d("porfavor",MainActivity.players.get(0).getPlayerName());
    ...
    private void FillPlayerList() {
      /*  playerList.add(new PlayerR(1,R.drawable.ronaldo, "Cristiano Ronaldo Dos Santos Aveiro","Cristiano Ronaldo","07/02/1985",
                "Ganador de 5 balones de oro", "Portugal"));
        playerList.add(new PlayerR(2,R.drawable.navas, "Keylor Antonio Navas Gamboa","Keylor Navas","15/10/1986",
                "Considerado uno de los mejores porteros del mundo", "Costa Rica"));
        playerList.add(new PlayerR(3,R.drawable.messi, "Lionel Andres Messi Cuccittini","Messi","24/06/1987",
                "Ganador de 5 balones de oro", "Argentina"));
        teamList.add(new TeamR(1,"Real Madrid","Spain",R.drawable.ronaldo,"LaLiga", "Madrid"));

        teamList.add(new TeamR(2,"Barcelona F.C.","Spain",R.drawable.ronaldo,"LaLiga", "Barcelona"));

        pxtList.add(new PlayerXTeamR(1,"Delantero",1,1,"2","2","0","0","0"));
        pxtList.add(new PlayerXTeamR(2,"Portero",2,1,"2","2","siempre","0","0"));
        pxtList.add(new PlayerXTeamR(3,"Delantero",3,2,"2","2","0","0","0"));
*/
